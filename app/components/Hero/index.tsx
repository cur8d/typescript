    ...
    <section className="container mx-auto px-4 pt-20 text-center">
      ...
      <div className="flex justify-center gap-4">
        <Link
          ...
          className="focus-ring inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-background px-8 py-3 text-sm font-medium transition-colors hover:bg-secondary"
          target="_blank"
